  ...
  return (
    <div className="sticky top-0 z-10 bg-white">
      <div className="container mx-auto p-5 flex space-between">
        {/* the logo region */}
        <div className="flex-none items-center cursor-pointer" onClick={()=>showHome()}>
          <img
        ...
        <div className="flex-none">
          <div className="header-button-holder">
            <button className="header-button" onClick={()=>handleProfileClicked()}>
              <span className="material-icons">account_circle</span>
            </button>
            <button className="header-button" onClick={()=>handleLogoutClicked()}>
